...
### Listening Port <a href="#listening-port" id="listening-port"></a>
...
#### Charset Encoding <a href="#charset-encoding" id="charset-encoding"></a>

UTF-8

### interview method -- JSON call details <a href="#interview-method-json-call-details" id="interview-method-json-call-details"></a>
...
{"jsonrpc":"2.0","id":"null","result":{"chainId":9,"chainName":"nerve","defaultAsset":{"key":"9-1","chainId":9,"assetId":1,"symbol":"NVT","decimals":8,"initCoins":0,"address":null,"status":1},……
...
1. type the URL of the API (<http://127.0.0.1:7003>)
...
#### Remote Procedure Call Examples <a href="#remote-procedure-call-examples" id="remote-procedure-call-examples"></a>
...
#### Return Format <a href="#return-format" id="return-format"></a>
...
### Sample Calls <a href="#sample-calls" id="sample-calls"></a>

#### Token Swap <a href="#token-swap" id="token-swap"></a>
...
#### Return Definition <a href="#return-definition" id="return-definition"></a>
...
### Calls Categorized by Blockchain Function <a href="#calls-categorized-by-blockchain-function" id="calls-categorized-by-blockchain-function"></a>

#### Chain Related \[chain] <a href="#chain-related-chain" id="chain-related-chain"></a>
...
#### Block Related \[block] <a href="#block-related-block" id="block-related-block"></a>
...
#### Account Related \[account] <a href="#account-related-account" id="account-related-account"></a>
...
#### Transaction Related \[transaction] <a href="#transaction-related-transaction" id="transaction-related-transaction"></a>
...
#### Consensus Related \[consensus] <a href="#consensus-related-consensus" id="consensus-related-consensus"></a>
...
[**#**](https://docs.nuls.io/Docs/i_public_service.html#get-node-s-stake-history)**Get node's stake history**
...
[**#**](https://docs.nuls.io/Docs/i_public_service.html#query-account-s-stake-list)**Query account's stake list**
...
#### Contract Related \[contract] <a href="#contract-related-contract" id="contract-related-contract"></a>
...
#### Statistics Related \[statistical] <a href="#statistics-related-statistical" id="statistics-related-statistical"></a>
