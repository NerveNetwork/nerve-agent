...
Enables mainstream LLMs and Agents to use Nerve as **native payment**: fast payments, no gas fees, decentralized, locally generated and managed accounts. Also supports **PayBox multi-chain collection**: accept payments from Ethereum, BSC, Polygon, TRON, NULS, NERVE — receive USDT on your Nerve address.
...
| [paybox-flow.md](paybox-flow.md) | PayBox multi-chain collection flow |
...
AI Agent quick integration skills:
- **Nerve payments**: [.cursor/skills/nerve-agent-payment/SKILL.md](../.cursor/skills/nerve-agent-payment/SKILL.md)
- **PayBox collection**: [.cursor/skills/paybox-payment/SKILL.md](../.cursor/skills/paybox-payment/SKILL.md)
